...
class MemStorage {
  ...
  private seedData() {
    // 6 Focused Stations split across CMC CS2 (Vạn Phúc - Hà Đông) and CMC CS1 (Duy Tân - Cầu Giấy)
    const initialStations: Station[] = [
      // === CMC CS2: Vạn Phúc, Hà Đông (CS2 Focus) ===
      {
        id: "S01",
      ...
      // === CMC CS1: Duy Tân, Cầu Giấy (CS1 Focus) ===
      {
        id: "S04",
